...
<html lang="en">
  ...
  <body>
    <main>
      <section class="modal">
        <div class="top">
          <a href="set_username.php" class="btn_close"><i class="fas fa-times"></i></a>
          <div class="img">
            <img src="/assets/img/x.png" alt="" width="50px" />
          </div>
        </div>
        <div class="section_btn">
          <h2 class="title">Que voulez-vous voir sur X ?</h2>
          <p>Sélectionnez au moins 3 intérêts pour personnaliser votre expérience sur X. Ils seront visibles sur votre profil.</p>
          <form action="" method="post">
            
            <a href="set_sub_category.php" type="submit" class="btn_next">Suivant</a>
          </form>
        </div>
      </section>
    </main>
