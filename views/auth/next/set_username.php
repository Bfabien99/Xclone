...
<html lang="en">
  ...
  <body>
    <main>
      <section class="modal">
        <div class="top">
          <a href="set_profil_img.php" class="btn_close"><i class="fas fa-times"></i></a>
          <div class="img">
            <img src="/assets/img/x.png" alt="" width="50px" />
          </div>
        </div>
        <div class="section_btn">
          <h2 class="title">Comment voulez-vous qu'on vous appelle ?</h2>
          <p>Votre @nomdutilisateur est unique. Vous pouvez toujours le modifier ultérieurement.</p>
          <form action="" method="post">
            <div class="box">
            <div class="input_edit">
              <span class="input_edit_label_one">Nom d'utilisateur</span>
              <input
                type="text"
            ...
            <p class="resend">@username</p>
            </div>
            <a href="set_category.php" type="submit" class="btn_next">Suivant</a>
          </form>
        </div>
      </section>
    </main>
