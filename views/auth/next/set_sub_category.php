...
<html lang="en">
  ...
  <body>
    <main>
      <section class="modal">
        <div class="top">
          <a href="set_category.php" class="btn_close"><i class="fas fa-times"></i></a>
          <div class="img">
        ...
        <div class="section_btn">
          ...
          <p>Les intérêts sont utilisés pour personnaliser votre expérience et sont visible sur votre profil.</p>
        </div>
        <a href="set_follow.php" type="submit" class="btn_next">Suivant</a>
      </section>
    </main>
  </body>
  <script>
