    ...
    <main>
      <section class="modal">
        ...
        <div class="section_btn">
          <h2 class="title">Nous vous avons envoyé un code</h2>
          <p>Saisissez-le ci-dessous pour verifier</p>
          <form action="" method="post">
            <div class="box">
            <div class="input_edit">
              <span class="input_edit_label_one">code de vérification</span>
              <input
                type="text"
            ...
            <p class="resend">Vous n'avez pas reçu de code?</p>
            </div>
            <a href="set_password.php" type="submit" class="btn_next">Suivant</a>
          </form>
        </div>
      </section>
    </main>
